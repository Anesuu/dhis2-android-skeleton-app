    ...
    public Flowable<Map<String, FormField>> getEnrollmentFormFields() {
        ...
        return Flowable.fromCallable(() -> {
            //TODO: replace with program attributes
                    ...
                    return d2.programModule().programs.uid(programUid).withAllChildren().get().programTrackedEntityAttributes();
            ...
            for(ProgramTrackedEntityAttribute programTrackedEntityAttribute : programAttributeList){
                TrackedEntityAttribute attribute = Sdk.d2().trackedEntityModule().trackedEntityAttributes
                        .uid(programTrackedEntityAttribute
                                .trackedEntityAttribute().uid()).get();
                TrackedEntityDataValueObjectRepository attrRepo =
                        Sdk.d2()
                        .trackedEntityModule()
