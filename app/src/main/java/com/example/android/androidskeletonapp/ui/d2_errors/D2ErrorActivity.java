...
public class D2ErrorActivity extends ListActivity {
    ...
    private void observeErrors(){
        ...
        LiveData<PagedList<D2Error>> errorsPagedListLiveData =
                Sdk.d2().maintenanceModule().d2Errors.getPaged(12);

                        errorsPagedListLiveData.observe(this,errorsPagedList ->{
                            adapter.submitList(errorsPagedList);
                            findViewById(R.id.d2ErrorsNotificator).setVisibility(errorsPagedList.isEmpty() ? View.VISIBLE : View.GONE);
                        });
